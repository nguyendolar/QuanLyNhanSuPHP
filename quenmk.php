                                    ...
                                    <div class="card-body">
                                        <form action="checklogin.php" method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary" style="margin:0px auto !important" type="submit" name="quenmk">Gửi mail cấp mật khẩu mới</button>
                                                <a href="login.php" style="margin:0px auto !important" >Quay lại đăng nhập</a>
                                            </div>
