        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách kỷ luật</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                <?php 
                                    $query = "SELECT a.*,b.hoten FROM kyluat as a, nhanvien as b WHERE a.nhanvien_id = b.id  ORDER BY a.id DESC";
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="function.php" method="POST" >
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <label for="category-film"
                                                                class="col-form-label">Nội dung kỷ luật:</label>
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="suakl">Lưu</button>
                                                </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Đóng</button>
                                                    <button type="submit" class="btn btn-primary" name="themkl">Lưu </button>
                                                </div>
                                                    </form>
                                                </div>
