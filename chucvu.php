        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách chức vụ</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                <?php 
                                    $query = "SELECT * FROM chucvu ORDER BY id DESC";
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="function.php" method="post">
                                                                ...
                                                                <div class="modal-footer" style="margin-top: 20px">
                                                                    ...
                                                                    <button style="width:100px" type="submit" class="btn btn-danger" name="xoacv"> Xóa</button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Đóng</button>
                                                    <button type="submit" class="btn btn-primary" name="themcv">Lưu </button>
                                                </div>
                                                    </form>
                                                </div>
