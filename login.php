                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Quản Lý Nhân Sự</h3></div>
                                    <div class="card-body">
                                        <form action="checklogin.php" method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a href="quenmk.php" style="margin:0px auto !important" >Quên mật khẩu</a>
                                            </div>
                                        </form>
                                    </div>
