        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách chấm công cá nhân</h1>
                    <div class="card mb-4">
                                                ...
                                                <div class="modal-body">
                                                    <form action="function.php" method="POST" >
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            ...
                                                            <input type="time" class="form-control" id="category-film" value="<?php echo $arUser["dilam"] ?>" name="dilam" required>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                            <label for="category-film"
                                                                class="col-form-label">Đi về:</label>
                                                            <input type="time" class="form-control" id="category-film" value="<?php echo $arUser["dive"] ?>" name="dive" required>
                                                        </div>
                                                        <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Đóng</button>
                                                    <button type="submit" class="btn btn-primary" name="suacc">Lưu</button>
                                                </div>
                                                    </form>
                                                </div>
