...
define("SMTP_UNAME", "n2ftechnology@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "qtfghkoibenvzzot"); //Password for SMTP authentication
